...
namespace draw
{
    ...
    inline int wallLeftEdgeCoordX;
    inline void GameModeSelection()
    {
        system("cls");
        setColor(187);
    ...
    inline void EmptyField(int indentX, int indentY)
    {
        setColor(11);
    ...
    inline void CoordinatesToRightField(int indentX, int indentY)
    {
        setColor(13);
    ...
    inline void CoordinatesToBothFields(int indentX1, int indentX2, int indentY)
    {
        setColor(13);
    ...
    namespace ships_arrangement
    {
        ...
        inline int indentX_leftColumn, indentX_rightColumn, indentY_upper, indentY_middle, indentY_lower, width_leftColumn,
        ...
        inline bool buttonClear_isActive = false,
                    buttonDone_isActive  = false;

        inline int getShipsWidth(int decksAmount, int shipsAmount);

        inline void setIndents()
        {
        ...
        inline void ResetShipsAmounts(int d1 = 0, int d2 = 0, int d3 = 0, int d4 = 0)
        {
        ...
        inline void RemainingShips(string draw_or_clear_or_redraw, int amount_1deckShips = 4, int amount_2deckShips = 3,
        ...
        inline void InstructionText(int indentX, int indentY, string write_or_clear)
        {
        ...
        inline void Phrase_invalidSet(string write_or_clear)
        {
            assert(write_or_clear == "write" || write_or_clear == "clear");
        ...
        inline void Phrase_ArrangeYourShips(string write_or_clear)
        {
            int phraseWidth = 92;
        ...
        inline void Phrase_PlayerOnTheLeft(string write_or_clear)
        {
            int phraseWidth = 79;
            int indentX = nConsoleWidth / 2 - phraseWidth / 2, indentY = 0;
            assert(write_or_clear == "write" || write_or_clear == "clear" || write_or_clear == "draw");
        ...
        inline void Phrase_PlayerOnTheRight(string write_or_clear)
        {
            int phraseWidth = 88;
            int indentX = nConsoleWidth / 2 - phraseWidth / 2, indentY = 0;
            assert(write_or_clear == "write" || write_or_clear == "clear" || write_or_clear == "draw");
        ...
        inline void Buttons(string draw_or_clear)
        {
        ...
        inline void ButtonClear(bool activate)
        {
            // wall
        ...
        inline void ButtonDone(bool activate)
        {
            // wall
            if(activate) setColor(34);
            else setColor(136);
    ...
    inline void MoveIndicatingArrows(int fieldIndentX, string how, bool gameForTwo = 0)
    {
    ...
    inline void Victory(bool singleGame, int whoWon = 0)
    {
    ...
    inline void Loss(bool singleGame, int whoLost = 0)
    {
